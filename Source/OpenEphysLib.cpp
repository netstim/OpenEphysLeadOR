...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo *info)
{
	...
	case 0:
		...
		// Processor name
		info->processor.name = "Lead-OR"; // Processor name shown in the GUI
		...
		// Class factory pointer. Replace "ProcessorPluginSpace::LeadORPlugin" with the namespace and class name.
		info->processor.creator = &(Plugin::createProcessor<LeadORPlugin>);
		break;
	default:
		return -1;
		break;
